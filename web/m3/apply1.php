 ...
 * Desc: 海外人才对接会 招商报名
 */
$title = '百名海外博士深圳行-招商报名';
?>
<?php require_once 'header.php';?>
<div class="main">
    <div class="main1">
        <img class="background_img" src="img/page1.jpg" >
        <div class="zs_apply">
            <form action="/index.php/front/bbx/apply" method="post" class="zs_form">
                <div class="zs_form_item">
                    <div class="zs_form_name">
                        单位名称 Organization:
                    </div>
                    <div class="zs_form_input">
                        <input type="text" name="param[organization]" required="required">
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="zs_form_item">
                ...
                <input type="hidden" name="param[t]" value="1">
                <div class="submit">
